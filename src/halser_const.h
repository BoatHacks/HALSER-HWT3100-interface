...
// HWT3100-TTL recommended baud rate (ARCHITECTURE.md §5, SPEC.md §1.2,
...
// what the module is actually on: the module's factory default is
// 9600, and gateway.cpp's persisted /hwt3100/baud config item (auto-
// detected or explicitly set) is the actual source of truth once
// known.
